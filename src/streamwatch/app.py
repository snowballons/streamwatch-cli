...
class StreamWatchApp:
    ...
    def __init__(self, container: DIContainer = None):
        ...
        self.logger.info("StreamWatch application initialized with dependency injection")
    ...
    def run(self) -> None:
        ...
        try:
            ...
            self._handle_graceful_shutdown("Script interrupted by user. Exiting gracefully. Goodbye!")
        except Exception as e:
            self.logger.critical("An unexpected critical error occurred in the application", exc_info=True)
    ...
    def _refresh_live_streams(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if not all_configured_streams:
                ui.console.print("No streams configured. Use 'A' to add some!", style="warning")
                return []
